...
data = dict(
    train=dict(
        img_prefix='/home/E/data/aoi/Connector/special/coco_ds/output_train_coco/',
        classes=classes,
        ann_file='/home/E/data/aoi/Connector/special/coco_ds/output_train_coco/annotations.json'),
    val=dict(
        img_prefix='/home/E/data/aoi/Connector/special/coco_ds/output_train_coco/',
        classes=classes,
        ann_file='/home/E/data/aoi/Connector/special/coco_ds/output_train_coco/annotations.json'),
