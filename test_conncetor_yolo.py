...
config_file = 'configs/aoi/conncetor/yolox_s_8x8_300e_coco_connector.py'
# 从 model zoo 下载 checkpoint 并放在 `checkpoints/` 文件下
# 网址为: http://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth
# checkpoint_file = 'work_dirs/faster_rcnn_r50_fpn_2x_coco_mirror_surface/latest.pth'
checkpoint_file = 'work_dirs/yolox_s_8x8_300e_coco_connector/best_bbox_mAP_epoch_296.pth'
device = 'cuda'
# 初始化检测器
...
# test_dir=r'/home/E/data/aoi/Connector/output_train_coco_1/JPEGImages'
...
for item in test_filelist:
    ...
    for index,finger in enumerate(res[0]):
        if finger[4]>0.7:
            ...
            finger_img=src[int(finger[1]-10):int(finger[3]+10),int(finger[0]-10):int(finger[2]+10)]
            cv2.imwrite(r'/home/E/data/aoi/Connector/finger3/'+item+"_"+str(index)+".jpg",finger_img)
